...
export const PersonalityProfile: React.FC<PersonalityProfileProps> = ({
  ...
  const data = [
    ...
    { name: 'Danceability', value: Math.round(profile.personality.danceability) },
    { name: 'Acousticness', value: Math.round(profile.personality.acousticness) },
...
const PersonalityExplanation: React.FC<PersonalityExplanationProps> = ({
  ...
  if (energy > 70) {
    explanation += 'You\'re drawn to high-energy, intense music that keeps you moving. ';
  } else if (energy < 40) {
  ...
  if (danceability > 75) {
    explanation += 'Every beat moves you—rhythm is essential to your music taste.';
  }
